...
from controller.register_patientController import register_blueprint
from controller.measurementController import measurement_blueprint

app = Flask(__name__)

app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:jose131997@localhost/DTM'
